...
type resourceLoggingIPv6HostTransportType struct{}

func (t resourceLoggingIPv6HostTransportType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
