...
func (t resourceVLANType) NewResource(ctx context.Context, in provider.Provider) (resource.Resource, diag.Diagnostics) {
...
func (r resourceVLAN) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan VLAN
...
func (r resourceVLAN) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state VLAN
...
func (r resourceVLAN) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state VLAN
...
func (r resourceVLAN) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state VLAN
...
func (r resourceVLAN) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
