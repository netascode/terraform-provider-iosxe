...
var (
	_ datasource.DataSource              = &BGPAddressFamilyIPv6DataSource{}
	_ datasource.DataSourceWithConfigure = &BGPAddressFamilyIPv6DataSource{}
)

func NewBGPAddressFamilyIPv6DataSource() datasource.DataSource {
	return &BGPAddressFamilyIPv6DataSource{}
}
...
func (d *BGPAddressFamilyIPv6DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the BGP Address Family IPv6 configuration.",
