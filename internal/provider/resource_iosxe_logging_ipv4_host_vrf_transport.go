...
func (t resourceLoggingIPv4HostVRFTransportType) NewResource(ctx context.Context, in provider.Provider) (resource.Resource, diag.Diagnostics) {
...
func (r resourceLoggingIPv4HostVRFTransport) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r resourceLoggingIPv4HostVRFTransport) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
...
func (r resourceLoggingIPv4HostVRFTransport) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r resourceLoggingIPv4HostVRFTransport) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state LoggingIPv4HostVRFTransport
...
func (r resourceLoggingIPv4HostVRFTransport) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
