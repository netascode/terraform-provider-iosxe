...
func (data LoggingIPv6HostVRFTransport) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XE-native:native/logging/host/ipv6/ipv6-host-vrf-transport-list=%s,%s", url.QueryEscape(fmt.Sprintf("%v", data.Ipv6Host.Value)), url.QueryEscape(fmt.Sprintf("%v", data.Vrf.Value)))
}
...
func (data *LoggingIPv6HostVRFTransport) setUnknownValues(ctx context.Context) {
...
func (data *LoggingIPv6HostVRFTransport) getDeletedListItems(ctx context.Context, state LoggingIPv6HostVRFTransport) []string {
