...
var (
	_ datasource.DataSource              = &BGPIPv4UnicastNeighborDataSource{}
	_ datasource.DataSourceWithConfigure = &BGPIPv4UnicastNeighborDataSource{}
)

func NewBGPIPv4UnicastNeighborDataSource() datasource.DataSource {
	return &BGPIPv4UnicastNeighborDataSource{}
}
...
func (d *BGPIPv4UnicastNeighborDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the BGP IPv4 Unicast Neighbor configuration.",
