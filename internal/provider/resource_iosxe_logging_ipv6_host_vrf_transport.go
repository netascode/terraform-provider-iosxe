...
type resourceLoggingIPv6HostVRFTransportType struct{}

func (t resourceLoggingIPv6HostVRFTransportType) GetSchema(ctx context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
