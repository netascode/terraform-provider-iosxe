...
func (t dataSourceInterfaceLoopbackType) NewDataSource(ctx context.Context, in provider.Provider) (datasource.DataSource, diag.Diagnostics) {
...
func (d dataSourceInterfaceLoopback) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
