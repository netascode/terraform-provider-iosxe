...
func (data LoggingIPv4HostVRFTransport) getPath() string {
	return fmt.Sprintf("Cisco-IOS-XE-native:native/logging/host/ipv4-host-vrf-transport-list=%s,%s", url.QueryEscape(fmt.Sprintf("%v", data.Ipv4Host.Value)), url.QueryEscape(fmt.Sprintf("%v", data.Vrf.Value)))
}
