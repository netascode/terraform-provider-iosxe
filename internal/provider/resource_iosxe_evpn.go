...
func (t resourceEVPNType) NewResource(ctx context.Context, in provider.Provider) (resource.Resource, diag.Diagnostics) {
...
func (r resourceEVPN) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan EVPN
...
func (r resourceEVPN) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state EVPN
...
func (r resourceEVPN) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state EVPN
...
func (r resourceEVPN) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state EVPN
...
func (r resourceEVPN) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
